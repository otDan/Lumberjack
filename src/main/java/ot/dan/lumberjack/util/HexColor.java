...
public class HexColor {
    ...
    private static String parseGradients(String message) {
        ...
        while (matcher.find()) {
            ...
            List<java.awt.Color> hexSteps = Arrays.stream(hexContent.split(":")).map(java.awt.Color::decode).collect(Collectors.toList());
    ...
    private static String translateHex(java.awt.Color color) {
    ...
    public static class Gradient {
        ...
        public Gradient(List<java.awt.Color> colors, int totalColors) {
            if (colors.size() < 2)
        ...
        public java.awt.Color next() {
            ...
            if (this.stepIndex + 1 < this.colors.size()) {
                java.awt.Color start = this.colors.get(this.stepIndex);
                java.awt.Color end = this.colors.get(this.stepIndex + 1);
         ...
         */
        public static java.awt.Color getGradientInterval(java.awt.Color start, java.awt.Color end, float interval) {
    ...
    public static class Rainbow {
         ...
         */
        public java.awt.Color next() {
            java.awt.Color color = java.awt.Color.getHSBColor(this.hue, this.saturation, this.brightness);
